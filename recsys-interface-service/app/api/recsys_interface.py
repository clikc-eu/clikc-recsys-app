...
async def get_recommendations_for_user(user_id: int, num_pred: int = 100, client_session: ClientSession = Depends(client_session_dep), api_key: APIKey = Depends(authentication)):
    '''
